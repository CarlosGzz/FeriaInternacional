...
<div class="col-lg-4 col-md-4 col-sm-10 col-xs-10 panel panel-default">
	...
	<div class = "panel-body">
		...
		<div class="form-group">
			...
			{!! Form::select('estatus', ['activo' => 'Activo', 'inactivo' => 'Inactivo'], $edicion->estatus, ['class'=>'form-control','required','placeholder' => 'Estatus de la edicion..']) !!}
		</div>
		<!--ID de Admin-->
			<div class="form-group">
				{!! Form::hidden('administrador_id',$edicion->administrador_id)!!}
			</div>
		<hr>
		<!--Boton-->
		<div class="form-group">
